...
public class PaymentRequest3D {
    ...
    @XmlElementRef(name = "paResponse", namespace = "http://payment.services.adyen.com", type = JAXBElement.class)
    protected JAXBElement<String> paResponse;
     ...
     *     
     */
    public JAXBElement<String> getPaResponse() {
        return paResponse;
    }
     ...
     *     
     */
    public void setPaResponse(JAXBElement<String> value) {
        this.paResponse = ((JAXBElement<String> ) value);
    }
