...
<html lang="en">
    ...
    <body>
        <content tag="content">
            <div id="aboutUs">
                <h1><g:message code="about.termsUse.title"/></h1>
				<g:render template="conceptMenu" model="[selected:'termsUse']" />

				<p>This acceptable use policy sets out the terms between you and us under which you may access our website www.carmine.co.uk (our site). This acceptable use policy applies to all users of, and visitors to, our site.</p>
				<p>Your use of our site means that you accept, and agree to abide by, all the policies in this acceptable use policy, which supplement our <g:link action="terms">terms and conditions</g:link>.</p>
				<p>www.carmine.co.uk is a site operated by Carmine Interactive Ltd. (we or us).  We are registered in England and Wales under company number 7647027 and we have our registered office at Lacon House, 84 Theobald’s Road, London WC1X 8RW.  Our main trading address is 185 Park Street, London SE1 9DY. Our VAT number is 118 5281 17. </p>

				<h3>PROHIBITED USES<hr/></h3>
				...
				<p>You also agree:</p>
				<ul>
					<li>Not to reproduce, duplicate, copy or re-sell any part of our site in contravention of the provisions of our <g:link action="terms">terms and conditions</g:link>.</li>
				...
				<ul>
					...
					<li>Product voting and commenting.</li>
					<li>Polls.</li>
					<li>Interactive beauty questionnaire.</li>
				</ul>
				...
				<p>Failure to comply with this acceptable use policy constitutes a material breach of the terms of use [INSERT AS LINK TO TERMS OF USE] upon which you are permitted to use our site, and may result in our taking all or any of the following actions:</p>
				<ul>
